                                        ...
                                        <div class="product-img">
                                            <a href="{{ route('product-detail', $product->slug) }}">
                                                @php
                                                    ...
                                                    $photoPath = $photos[0] ? asset('storage/' . $photos[0]) : 'https://via.placeholder.com/400x400';
                                                @endphp
                                                <img class="default-img" src="{{ $photoPath }}" alt="{{ $product->title }}">
                                                <img class="hover-img" src="{{ $photoPath }}" alt="{{ $product->title }}">
                                                @if ($product->stock <= 0)
                ...
                @if ($featured)
                    @foreach ($featured as $data)
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="single-banner">
                                @php
                                    $photo = $data->photo ? explode(',', $data->photo) : [];
                                @endphp
                                @if (!empty($photo))
                                    <img src="{{ asset('storage/' . $photo[0]) }}" alt="{{ $data->title }}">
                                @else
                                    <img src="https://via.placeholder.com/600x400" alt="default image">
                                @endif

                                <div class="content">
                                    <p>{{ $data->cat_info['title'] ?? 'No Category' }}</p>
                                    ...
                                    <div class="product-img">
                                        <a href="{{ route('product-detail', $product->slug) }}">
                                            @php
                                                ...
                                                $photoPath = $photo[0] ? asset('storage/' . $photo[0]) : 'https://via.placeholder.com/400x400';
                                            @endphp
                                            <img class="default-img" src="{{ $photoPath }}" alt="{{ $product->title }}">
                                            <img class="hover-img" src="{{ $photoPath }}" alt="{{ $product->title }}">
                                        </a>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="list-image overlay">
                                                @php
                                                    ...
                                                    $photoPath = $photo[0] ? asset('storage/' . $photo[0]) : 'https://via.placeholder.com/400x400';
                                                @endphp
                                                <img src="{{ $photoPath }}" alt="{{ $product->title }}">
                                        ...
                                        <div class="quickview-slider-active">
                                            ...
                                            @foreach ($photo as $data)
                                                <div class="single-slider">
                                                    <img src="{{ asset('storage/' . $data) }}" alt="{{ $product->title }}">
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                        ...
                                        <form action="{{ route('single-add-to-cart') }}" method="POST" class="mt-4">
                                            ...
                                            <div class="quantity">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="quant[1]" class="input-number" value="1" data-min="1" data-max="1000">
