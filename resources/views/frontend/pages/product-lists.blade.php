                            ...
                            <div class="single-widget recent-post">
                                ...
                                @foreach ($recent_products as $product)
                                    ...
                                    <div class="single-post first">
                                        <div class="image">
                                            <img src="{{ asset('storage/' . $photo[0]) }}" alt="{{ $product->title }}">
                                        </div>
                                        <div class="content">
                                            <h5><a
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            @if (count($products))
                                                    ...
                                                    <div class="product-img">
                                                        <a href="{{ route('product-detail', $product->slug) }}">
                                                            @php
                                                                $photo = explode(',', $product->photo);
                                                            @endphp
                                                            <img class="default-img" src="{{ asset('storage/' . $photo[0]) }}"
                                                                alt="{{ $product->title }}">
                                                            <img class="hover-img"
                                                                src="{{ asset('storage/' . $photo[0]) }}"
                                                                alt="{{ $product->title }}">
                                                        </a>
                                ...
                                @endforeach
                            @else
                                <h4 class="text-danger" style="margin:100px auto;">Sorry, there are no products according
