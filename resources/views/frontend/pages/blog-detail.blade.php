                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>
                                                By
                            ...
                            @else
                                <p class="text-center p-5">
                                    You need to <a href="{{ route('login') }}" style="color:rgb(54, 54, 204)">Login</a> OR <a
                                        style="color:blue" href="{{ route('register') }}">Register</a> for comment.
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            ...
                            <ul class="categor-list">
                                @php $categories = Helper::postCategoryList('posts'); @endphp
                                {{ count($categories) }}
                            ...
                            @foreach ($recent_posts as $recent_post)
                                <div class="single-post">
                                    <div class="image">
                                        ...
                                        <img src="{{ asset('storage/' . $recent_post->photo) }}"
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="comment">
                                            <li><i class="fa fa-calendar"
                                                    aria-hidden="true"></i>{{ $recent_post->created_at->format('d M, y') }}
                                            </li>
                                            <li><i class="fa fa-user" aria-hidden="true"></i>
                                                {{ $recent_post->author->name ?? 'Anonymous' }}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
