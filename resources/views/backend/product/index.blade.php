...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{ route('admin.product.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                            ...
                            @foreach ($products as $product)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <sub>{{ $product->subCategory->title ?? '' }}</sub>
                                    </td>
                                    ...
                                    <td>
                                        @if ($product->photo)
                                            ...
                                            @endphp
                                            <img src="{{ asset('storage/' . $photo[0]) }}" class="img-fluid zoom"
